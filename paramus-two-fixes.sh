...
case "$guardian_hash" in
    ...
    *) die 'Guardian differs from the saved 6.1.1 or this patched version. No changes made; review that PC’s Guardian before patching.' ;;
esac
...
[[ "$(sha256sum "$guardian" | awk '{print $1}')" == 'bc387372c8b4a680be929ec811f8ec8a5664026802896303e01334b7df764c38' ]] || die "Guardian verification failed. Backup: $backup"
